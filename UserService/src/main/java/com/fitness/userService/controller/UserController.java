...
public class UserController {
    ...
    @PostMapping("/login")
    public ResponseEntity<ApiResponse<UserDTO>> loginUser(@Valid @RequestBody LoginRequestDTO loginRequestDTO){
    ...
    public ResponseEntity<ApiResponse<String>> updateUser(@PathVariable(name = "id") Long id,
                                                          @Parameter(description = "Please provide valid valid User object",
